...
//objets
icones_arme[0] = *(new Sprite(5,0,*new Taille(32,32))); // null
icones_arme[1] = *(new Sprite(5,1,*new Taille(32,32))); // epee1
...
descriptions[1] = "LES HUMAINS SONT CONNUS POUR LEUR AFFINITE POUR LA MAGIE.";
descriptions[2] = "LES ELFES SONT DOUES POUR LES ARMES A DISTANCE.";
// classes
descriptions[3] = "LES GUERRIERS SONT ROBUSTES, PEUVENT PARRER ET UTILISENT LA FORCE POUR ATTAQUER.";
descriptions[4] = "LES ARCHERS ESQUIVENT, ONT UNE FORTE CHANCE DE CRITIQUE ET UTILISENT L'HABILETE POUR ATTAQUER.";
descriptions[5] = "LES MAGES FONT MAL,ON NE PEUT LES ESQUIVER ET ILS UTILISENT L'INTELLIGENCE POUR ATTAQUER.";
// mobs
