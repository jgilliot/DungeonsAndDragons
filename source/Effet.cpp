...
Effet::Effet(char * nom,bool self,int tours,int pvMax,int pv,int mana,int manaMax,int force,int habilete,int intelligence,int endurance, int chance){
this->nom = nom;
this->self = self;
this->nb_tours = tours;
...
bool Effet::getSelf(){return this->self;}
int Effet::getNb_tours(){return this->nb_tours;}
